...
st.write('''
Привет, прекрасная коллега!

Иногда нам всем в течение рабочего дня становится немного грустно, особенно на удаленке, без любимых коллег рядом.
Поэтому мы рады видеть тебя в нашем новом приложении, предназначенном для поднятия настроения! 
         
Чуть ниже есть две загадочные кнопки, скорее нажимай!
